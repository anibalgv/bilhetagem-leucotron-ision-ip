<template>
  <div id="app">
    <head>
      ...
      <title>BILHETAGEM LEUCONTRON</title>
      ...
      <link
        rel="shortcut icon"
        href="static/assets/media/favicons/favicon.png"
      />
      <link
        rel="icon"
        type="image/png"
    ...
    -->
      <div
        id="page-container"
        class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow sidebar-mini"
      >
        <!-- Side Overlay-->
        <aside id="side-overlay">
          ...
          <div class="content-header border-bottom">
            ...
            <div class="ml-2">
              <a
                class="text-dark font-w600 font-size-sm"
            ...
            <a
              class="ml-auto btn btn-sm btn-alt-danger"
              href="javascript:void(0)"
              data-toggle="layout"
                        ...
                        <li>
                          ...
                          >
                            ...
                            <div class="media-body">
                              ...
                              <div class="text-info">Documentation.doc</div>
                              <small class="font-size-sm text-muted"
                                >15 min ago</small
                              >
                            </div>
                      ...
                      <ul class="nav-items mb-0">
                        <li>
                          <a class="media py-2" href="javascript:void(0)">
                            <div
                              class="mr-3 ml-2 overlay-container overlay-bottom"
                            >
                              <img
                        ...
                        <li>
                          <a class="media py-2" href="javascript:void(0)">
                            ...
                            >
                              ...
                              />
                              <span
                                class="overlay-item item item-tiny item-circle border border-2x border-white bg-warning"
                              ></span>
                            </div>
                            <div class="media-body">
                  ...
                  <div class="block mb-0">
                    ...
                    <div class="block-content">
                      ...
                      >
                        ...
                        <div class="form-group">
                          <p class="font-size-sm font-w600 mb-1">API</p>
                          <div class="custom-control custom-switch mb-1">
                            <input
                              type="checkbox"
                              class="custom-control-input"
                    ...
                    <div class="block-content">
                      <div class="row items-push pull-t">
                        <div class="col-6">
                          ...
                          <a class="font-size-lg" href="javascript:void(0)"
                            >22.030</a
                          >
                        </div>
                        <div class="col-6">
          ...
          <div class="content-header bg-white-5">
            ...
            <div>
              ...
              <div class="dropdown d-inline-block ml-2">
                ...
                <div
                  class="dropdown-menu dropdown-menu-right font-size-sm smini-hide border-0"
        ...
        <header id="page-header">
          ...
          <div class="content-header">
            ...
            <div class="d-flex align-items-center">
              ...
              <button
                type="button"
                class="btn btn-sm btn-dual d-md-none"
                data-toggle="layout"
            ...
            <div class="row font-size-sm">
              <div class="col-sm-6 order-sm-2 py-1 text-center text-sm-right">
                <a href="https://executar.net" target="_blank">
                  <img
                    class
                    src="static/assets/media/favicons/executar-net-logo-gray.png"
                    alt
                  />
                </a>
              </div>
                ...
                <div class="block-content block-content-full">
                  <div class="row gutters-tiny">
                    <div class="col-6">
                      <!-- CRM -->
                      <a
                        class="block block-rounded block-link-shadow bg-body"
                        href="javascript:void(0)"
                      >
                    ...
                    <div class="col-6">
                      <!-- Sales -->
                      <a
                        class="block block-rounded block-link-shadow bg-body mb-0"
                        href="javascript:void(0)"
                      >
                        <div class="block-content text-center">
  ...
  window.$ = window.jQuery = require("jquery");
    ...
    -->
      <script
        type="application/javascript"
        src="static/assets/js/oneui.app.min.js"
      ></script>
      <!-- Page JS Plugins -->
