              ...
              <div class="block-content">
                ...
                >
                  <div class="block-content block-content-full text-center">
                    ...
                    <div class="font-size-sm text-muted text-uppercase">FROM APLIANCE TO LOCAL DATABASE</div>
                  </div>
                </a>
              </div>
            </div>
...
export default {
  methods: {
    async Import() {
      let wasImported = new Tickets().Import();
      console.log("wasImported :", wasImported.toString());
    },
  },
};
</script>
